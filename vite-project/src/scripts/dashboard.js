document.addEventListener('DOMContentLoaded', function() {
    ...
    function showUserMenu() {
      ...
      if (!userMenu) {
        ...
        userMenu.id = 'userDropdown';
        userMenu.className = 'user-dropdown';
        userMenu.innerHTML = `
          <div class="user-dropdown-content">
            <div class="user-info">
              <strong>${localStorage.getItem('username') || 'Usuário'}</strong>
        ...
        setTimeout(() => {
          document.addEventListener('click', function closeDropdown(e) {
            if (!userMenu.contains(e.target) && !document.getElementById('userButton').contains(e.target)) {
              userMenu.remove();
    ...
    function loadSection(section) {
      ...
      // Aqui você pode implementar a lógica para carregar diferentes seções
      // Por exemplo, fazer requisições AJAX para carregar conteúdo específico
    }
    ...
    function loadDashboardData() {
      ...
      // Você pode adicionar animações de loading aqui
      animateCounters();
    }
    ...
    // Funções globais para o menu dropdown
